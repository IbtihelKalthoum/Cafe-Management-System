        ...
        try {
            if(jwtFilter.isAdmin()){
                if(validateProductMap(requestMap,false)){
                    ...
                    return CafeUtils.getResonseEntity("Product Added Successfully", HttpStatus.OK);
                }
        ...
        try {
            if(jwtFilter.isAdmin()){
                ...
                if(!optional.isEmpty()){
                    ...
                    return CafeUtils.getResonseEntity("Product deleted successfully." ,HttpStatus.OK);
